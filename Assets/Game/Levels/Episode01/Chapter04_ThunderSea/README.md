...
현재 프로토타입은 공통 3D 테스트 경로에 천둥 바다의 남색·청색 계열 색상 팔레트만 적용합니다. 챕터 종료 후 `PrototypeStoryInterlude_Chapter04`를 거쳐 대기실로 돌아갑니다.
...
| 실제 파일 | 역할 | 확인 방법 |
|---|---|---|
| `PrototypeChapter04.unity` | 저장형 천둥 바다 3D 테스트 씬 | 대기실에서 Chapter 04 선택 |
| `PrototypeStoryInterlude_Chapter04.unity` | Chapter04 종료 후 영상 삽입용 placeholder | 챕터 종료 후 자동 이동 |
